...
public class RssParser {
     ...
     */
    public static Podcast parsePodcastFromXml(BufferedReader reader)
            throws XmlPullParserException, IOException {
        Podcast podcast = new Podcast();
        final int NUM_PODCAST_ITEMS = 2;
        /** allows exiting of parsing once files found */
        final int XML_CHANNEL_DEPTH = 3;
        /** depth of title and description fields in the xml tree */
        int itemsCounter = 0;
        /** a counter for the items we want to add into a podcast */
    ...
    // public static String parsePodcastImageFromXml(BufferedReader reader)
    // throws XmlPullParserException, IOException {
    // String imagelink = "";
    ...
    // }
    //
    // public static List<ContentValues> parseEpisodesFromXml(BufferedReader
    // reader, long id) throws XmlPullParserException, IOException,
    // ParseException {
    ...
    // String test = "";
    // String content = "";
    // SimpleDateFormat pubDateFormatter = new
    ...
    // Log.d("pubDate", "" + LazyAdapter.getDate(pubDate.getTime(),
     ...
     */
    public static String parsePodcastImageFromXml(InputStream stream)
            throws XmlPullParserException, IOException {
        String imagelink = "";
        boolean imageFound = false;
        ...
        while (eventType != XmlPullParser.END_DOCUMENT && (!imageFound)) {
            ...
            case (XmlPullParser.START_TAG):
                if (xpp.getDepth() == XML_CHANNEL_DEPTH) {
                    ...
                    /*
                     * if(imageItem.matches("url")){ imagelink = xpp.nextText();
                     * Log.d(TAG + " Image link: ", imagelink); imageFound =
                     * true; }
                     */
                }
                break;
