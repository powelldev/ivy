...
public class ChannelActivity extends ListActivity{
	...
	private void setupViews() {
		...
		getListView().setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Log.d("Mp3 already exists", Environment.getExternalStorageState() + "/" + Environment.DIRECTORY_PODCASTS + "/" + _episode.getTitle() + ".mp3");
				Toast.makeText(getApplicationContext(), _episode.getMp3(), Toast.LENGTH_LONG).show();
	...
	private void updateListAdapter(Context context, long id) {
		...
		/* SimpleCursorAdapter cursorAdapter = new SimpleCursorAdapter(context, android.R.layout.simple_list_item_1,
				...
				*/
		EpisodeAdapter cursorAdapter = new EpisodeAdapter(context, episodeCursor, 0);
